...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"activity.js":[function(require,module,exports) {
...
var miArrayIncial = [1, 2, 3, 4, 5, 6];
var unArrayNuevo = [7, 8, 9, 10, 11, 12];
console.log("Partimos de este Array: ", miArrayIncial); //1 . Arrays
// Head
...
console.log("Este es el primer elemento del array: ", head(miArrayIncial)); // Tail
...
var tail = function tail(_ref3) {
  var _ref4 = _toArray(_ref3),
      elements = _ref4.slice(1);

  return _toConsumableArray(elements);
};

console.log("Todos menos el primero: ", tail(miArrayIncial)); // Init
...
var init = function init(unArray) {
  return unArray.filter(function (element, index, unArray) {
    return index < unArray.length - 1 ? true : false;
  });
};

console.log("Todos menos el último: ", init(miArrayIncial)); // Last
...
console.log("El último: ", last(miArrayIncial)); // 2. Concat
...
console.log("Concateno 2 arrays: ", concat(miArrayIncial, unArrayNuevo)); // 3. Clone Merge
// Clone
...
var clone = function clone(_ref5) {
  var source = Object.assign({}, _ref5);
  return source;
};

var miNuevoObjeto = clone(miObjetoInicial);
console.log("Mi nuevo objeto clonado: ", miNuevoObjeto); // Merge
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","activity.js"], null)
//# sourceMappingURL=/activity.85f67325.js.map